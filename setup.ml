...
(* OASIS_START *)
(* DO NOT EDIT (digest: ab34d6883acfe576275115bda232c749) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Result"; "Error"; "Or_error"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "?\005\225\242\r\139/\147\135\235#<\025\215.\130";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
